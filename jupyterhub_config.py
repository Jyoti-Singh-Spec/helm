...
class ModelLabAuthenticator(Auth0OAuthenticator):
    @gen.coroutine
    def pre_spawn_start(self, user, spawner):
        ...
        spawner.environment['GITHUB_USER'] = auth_state['auth0_user']['https://app.model-lab.dunnhumby.com/ml_userid']
        spawner.environment['GITHUB_EMAIL'] = auth_state['auth0_user']['email']


c.JupyterHub.log_level = 'DEBUG'
c.JupyterHub.authenticator_class = ModelLabAuthenticator

c.ModelLabAuthenticator.auto_login = True
c.ModelLabAuthenticator.enable_auth_state = True
c.ModelLabAuthenticator.auth0_subdomain = "model-lab-dev.eu"
c.ModelLabAuthenticator.client_id =  "QVD5B3GTpZVbxilMh721pZdApNf9N6Xa"
c.ModelLabAuthenticator.client_secret = "EWgd6bPysGUyHGR2b1Dxl0jx8HvT19sncc7dfD-xxzQuTCbGJmf2vDq-MnmqBkL5"
c.ModelLabAuthenticator.authorize_url = "https://model-lab-dev.eu.auth0.com/authorize"
c.ModelLabAuthenticator.oauth_callback_url = "https://aks-playground.model-lab-stage.dunnhumby.com/hub/oauth_callback"
c.ModelLabAuthenticator.token_url = "https://model-lab-dev.eu.auth0.com/oauth/token"
c.ModelLabAuthenticator.scope = ['profile', 'email']
c.ModelLabAuthenticator.logout_redirect_url = "https://model-lab-dev.eu.auth0.com/v2/logout?returnTo=http%3A%2F%2Fapp.model-lab-staging.dunnhumby.com"
...
#c.JupyterHub.default_url = "/user/{username}/lab/"
...
c.KubeSpawner.pod_name_template = 'jupyterhub-{username}'
    ...
    node_selector = dict(
        matchExpressions=[
            dict(
                ...
                operator="In",
                values=["aks-agentpool-25169059-vmss000000"],
            )
        ],
    )
...
if storage_type == "static": 
    ...
    c.KubeSpawner.volumes = [
        {
            "name": "volume",
            "persistentVolumeClaim": {"claimName": "victorr"},
        }
    ]
    ...
    c.KubeSpawner.volumes = [
        {"name": "azurefile", "persistentVolumeClaim": {"claimName": "victorr"}}
    ]
...
c.KubeSpawner.working_dir = "/home/experiments"
...
#set_config_if_not_none(c.Spawner,  "default_url", "/user/{username}/lab/")
